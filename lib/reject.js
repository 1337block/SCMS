...
async function RejectToAddProductToSeller(data) {
      ...
      removeReqProductFromSellerReqProductList(seller.reqProductList, product.product_ID, distributor.distributor_ID);
      removeReqProductFromDistributorReqProductListForSeller(distributor.reqProductListFromSeller, seller.seller_ID, product.product_ID);
...
function removeReqProductFromSellerReqProductList(sellerReqProductList, productID, distributorID) {
...
function removeReqProductFromDistributorReqProductListForSeller(distributorReqProductListFromSeller, sellerID, productID) {
